...
Экспоненциальный поиск с лестничной оптимизацией работает лучше на эскпоненциальной генерации данных, чем на линейной(разница в скорости становится заметнее по мере увеличения M).
